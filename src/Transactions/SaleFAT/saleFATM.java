 ...
 * @author bansal
 */
public class saleFATM extends javax.swing.JInternalFrame {
...
/**
     ...
     */
    public saleFATM(JDesktopPane d) {
        initComponents();
...
this.dispose();
        try {
          ...
          SaleFATMonthly a=new SaleFATMonthly(account_list.get(alist.getSelectedIndex()),new Date(),pane);
          a.setVisible(true);
