 ...
 * @author bansal
 */
public class PurchaseFatBill extends javax.swing.JInternalFrame {
...
static int no_of_accounts=0;
     ...
     */
    public PurchaseFatBill(JDesktopPane d) throws Exception {    
    try{
       
        initComponents();
                this.setTitle("Purchase Fat Reports");
...
// TODO add your handling code here:
   ...
   if(g_list.getSelectedIndex()!=0){
       ...
       accounts.setAccount_typeid(constants.Account_type.PURCHASE_FAT);
...
String end_d=e_date.getDate().getYear()+1900+"/"+(e_date.getDate().getMonth()+1)+"/"+e_date.getDate().getDate();
            Reports.PurchaseFat sale_fat=new Reports.PurchaseFat(group_list.get(g_list.getSelectedIndex()).getGid(),start_d,end_d,accs);
