...
public class PurchaseSnf {
     ...
     public PurchaseSnf(int gid,String start_date,String end_date,ArrayList<Beans.accounts> accs) {
        ...
        Connection connection=DriverManager.getConnection(s,"dairy","bansal");
         String ss="select * from account_type order by account_typeid";
            ...
            JasperDesign jasDesign = JRXmlLoader.load(new File(".").getCanonicalPath()+"\\Report\\purchase_snf_all.jrxml");
