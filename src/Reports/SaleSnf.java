...
public class SaleSnf {
    ...
    public SaleSnf(int gid, String start_date, String end_date, ArrayList<Dao.accounts> accs) {
        ...
        try {
            ...
            JasperDesign jasDesign = JRXmlLoader.load(new File(".").getCanonicalPath() + ReportEnum.SALE_SNF_ALL.getReportName());
