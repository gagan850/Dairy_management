...
public class PurchaseList {
    ...
    public PurchaseList(int gid, String start_date, String end_date) {
        ...
        try {
            ...
            JasperDesign jasDesign = JRXmlLoader.load(new File(constant.Constant.DOT).getCanonicalPath() + ReportEnum.PURCHASE_LIST.getReportName());
