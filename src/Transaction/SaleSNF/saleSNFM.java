 ...
 * @author bansal
 */
public class saleSNFM extends javax.swing.JInternalFrame {
...
JDesktopPane pane=null;   
     ...
     */
    public saleSNFM(JDesktopPane d) {
        initComponents();
...
this.dispose();
        try {
          ...
          SaleSNFMonthly a=new SaleSNFMonthly(account_list.get(alist.getSelectedIndex()),new Date(),pane);
          a.setVisible(true);
