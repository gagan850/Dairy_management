...
/**
     ...
     */
    public SaleFATMutipleD(JDesktopPane d) {
        initComponents();
...
this.dispose();
        try {
            ...
            Transaction.SaleFatMultiple.SaleFATMultipleDaily a=new Transaction.SaleFatMultiple.SaleFATMultipleDaily(account_list.get(alist.getSelectedIndex()),new Date(),pane);
          a.setVisible(true);
