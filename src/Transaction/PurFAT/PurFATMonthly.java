 ...
 * @author bansal
 */
public class PurFATMonthly extends javax.swing.JInternalFrame implements CellEditorListener{
...
Dao.accounts selectedAccount=null;
     ...
     */
    public PurFATMonthly(Dao.accounts account,Date dt,JDesktopPane d ) throws SQLException, ParseException {    
    ...
    private void initComponents() {
        ...
        table = new javax.swing.JTable(){
            ...
            public boolean isCellEditable(int row,int column) {
                if(column==4||column==5||column==11|column==10||column ==9||column==0) // specify this depending upon ur requirement. Here the cell 2,3 is not editable.
                return false;
                else
                return true;
            }
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            row,
            new String [] {
                "Date","MMilk","Fat","Fat Rate","Ghee","Ammount","EMILK","Fat","Fat Rate","Ghee","Ammount","Total Ammount"
            }
        ));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(sum_mor_milk_l, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE)
                        ...
                        .addGap(37, 37, 37)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(sum_eve_ammount_l, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(sum_mor_ammount_l, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(206, 206, 206)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(sum_mor_ammount_l, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(sum_mor_milk_l, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE, false)
                    .addComponent(sum_eve_milk_l, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(sum_eve_ghee_l, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Reports.PurchaseFat sale_fat=new Reports.PurchaseFat(gid,start_d,end_d,accs);
  ...
  try{ if(((String)table.getValueAt(i, 10)).equals(""))
    ...
    Dao.pur_fat_transactions a=new Dao.pur_fat_transactions();
    a.setAid(aid);
    a.setGid(gid);
    ...
    a.setTdate(d);
    ArrayList<Dao.pur_fat_transactions> aa=a.get();
    Iterator<Dao.pur_fat_transactions> aaa=aa.iterator();
    int i=0;
 ...
 DecimalFormat df = new DecimalFormat("##.##");
    while(aaa.hasNext()){
        ...
        Dao.pur_fat_transactions aaaa=aaa.next();
